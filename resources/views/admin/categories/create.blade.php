                            ...
                            <form method="POST" action="{{ route('admin.categories.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-25">
                                        ...
                                        <input type="text" name="name" value="{{ old('name') }}" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Category Name">
                                    </div>

                                    <div class="col-md-6 mb-25">
                                        <label class="il-gray fs-14 fw-500 align-center mb-10">Slug</label>
                                        <input type="text" name="slug" value="{{ old('slug') }}" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Slug (optional)">
                                    </div>

                                    <div class="col-md-12 mb-25">
                                        <label class="il-gray fs-14 fw-500 align-center mb-10">Description</label>
                                        <textarea name="description" class="form-control ih-medium ip-gray radius-xs b-light px-15" placeholder="Description">{{ old('description') }}</textarea>
                                    </div>
